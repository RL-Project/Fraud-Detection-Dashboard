...
import { AlertCircle, CheckCircle, ChevronLeft, ChevronRight, MoreHorizontal, Search } from "lucide-react"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Review recent transactions and their fraud detection status</CardDescription>
          ...
          <TableBody>
            {transactions.map((transaction) => (
              <TableRow key={transaction.id}>
                ...
                <TableCell>{getStatusBadge(transaction.status, transaction.fraudScore)}</TableCell>
